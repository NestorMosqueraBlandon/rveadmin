        ...
        <div className="card">
            <div className="card__header">
                ...
                <div className="butttons">
                    <input type="text" placeholder="Search a product" value={search} onChange={(e) => setSearch(e.target.value)}/>
                    <button className="btn" onClick={() => setOpenModal(!openModal)}>Create</button>  
                </div>
            </div>
            {loading ? (
         ...
         
                {
                    ...
                    .map((category) => (
                        <tr key={category._id}>
                            ...
                            <td><button className="btn-icon"><i className='bx bx-pencil'></i></button>
                            <button className="btn-icon" onClick={() => deleteHandler(category)}><i className='bx bx-trash-alt'></i></button></td>
                        </tr>
                ...
                <div className="modal__dialog">
                    <div className="modal__card">
                        <div className="card__header b-line">
                            ...
                            <button className="card__title btn-icon" onClick={() => setOpenModal(!openModal)}><i className='bx bxs-x-circle'></i></button>
                        </div>
                        ...
                        <div className="card__footer">
                                <button className="btn" onClick={submitHandler}>Guardar</button>
                        </div>
                    </div>
                </div>
            </div>
